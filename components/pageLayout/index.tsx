...
const Main = (props: { children: ReactNode; className?: string }) => {
  return (
    <main
      className={twMerge(
        // Guideline: "Padding is set to a default of 24px" -> p-6
        // Guideline: "Space between a header and its associated content is 16px" -> pt-4 (was pt-3)
        clsx('grow overflow-y-auto p-6 pt-4', props.className),
      )}
    >
      {props.children}
    </main>
